...
const NpcModels = [
    ...
    new NpcBuilder(Npcs.Zoologist).loves(Npcs.WitchDoctor).likes(Biomes.Forest, Npcs.Golfer).dislikes(Biomes.Desert, Npcs.Angler).hates(Npcs.ArmsDealer).build(),
    new NpcBuilder(Npcs.Golfer).loves(Npcs.Angler).likes(Biomes.Forest, Npcs.Painter, Npcs.Zoologist).dislikes(Biomes.Underground, Npcs.Pirate).hates(Npcs.Merchant).build(),
    ...
    new NpcBuilder(Npcs.Wizard).loves(Npcs.Golfer).likes(Biomes.Hallow, Npcs.Merchant).dislikes(Biomes.Ocean, Npcs.WitchDoctor).hates(Npcs.Cyborg).build(),
    new NpcBuilder(Npcs.Demolitionist).loves(Npcs.Tavernkeep).likes(Biomes.Underground, Npcs.Mechanic).dislikes(Biomes.Ocean, Npcs.ArmsDealer, Npcs.GoblinTinkerer).build(),
    new NpcBuilder(Npcs.GoblinTinkerer).loves(Npcs.Mechanic).likes(Biomes.Underground, Npcs.DyeTrader).dislikes(Biomes.Jungle, Npcs.Clothier).hates(Npcs.Stylist).build(),
    new NpcBuilder(Npcs.Clothier).loves(Npcs.Truffle).likes(Biomes.Underground, Npcs.TaxCollector).dislikes(Biomes.Hallow, Npcs.Nurse).hates(Npcs.Mechanic).build(),
    new NpcBuilder(Npcs.DyeTrader).likes(Biomes.Desert, Npcs.ArmsDealer, Npcs.Painter).dislikes(Biomes.Forest, Npcs.Steampunker).hates(Npcs.Pirate).build(),
    new NpcBuilder(Npcs.ArmsDealer).loves(Npcs.Nurse).likes(Biomes.Desert, Npcs.Steampunker).dislikes(Biomes.Snow ,Npcs.Golfer).hates(Npcs.Demolitionist).build(),
    new NpcBuilder(Npcs.Steampunker).loves(Npcs.Cyborg).likes(Biomes.Desert, Npcs.Painter).dislikes(Biomes.Jungle, Npcs.Dryad, Npcs.Wizard, Npcs.PartyGirl).build(),
    new NpcBuilder(Npcs.Dryad).likes(Biomes.Jungle, Npcs.WitchDoctor, Npcs.Truffle).dislikes(Biomes.Desert, Npcs.Angler, Npcs.Zoologist).hates(Npcs.Golfer).build(),
    new NpcBuilder(Npcs.Painter).loves(Npcs.Dryad).likes(Biomes.Jungle, Npcs.PartyGirl).dislikes(Biomes.Forest, Npcs.Truffle, Npcs.Cyborg).build(),
    new NpcBuilder(Npcs.WitchDoctor).likes(Biomes.Jungle, Npcs.Dryad, Npcs.Guide).dislikes(Biomes.Hallow, Npcs.Nurse).hates(Npcs.Truffle).build(),
    new NpcBuilder(Npcs.Stylist).loves(Npcs.DyeTrader).likes(Biomes.Ocean, Npcs.Pirate).dislikes(Biomes.Snow, Npcs.Tavernkeep).hates(Npcs.GoblinTinkerer).build(),
    new NpcBuilder(Npcs.Angler).likes(Biomes.Ocean, Npcs.Demolitionist, Npcs.PartyGirl, Npcs.TaxCollector).dislikes(Biomes.Desert).hates(Npcs.Tavernkeep).build(),
